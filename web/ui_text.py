...
TEXT: Dict[str, Dict[str, str]] = {
    "vi": {
        ...
        "next_step": "Bước sau",
        "play_steps": "Tự chạy",
        "pause_steps": "Tạm dừng",
        "reset_steps": "Về đầu",
        "playback_speed": "Tốc độ phát",
        "seconds_per_step": "{seconds}s / bước",
        ...
        "image_setup_title": "Thiết lập ván chơi",
        "image_upload_hint": "Có thể tải ảnh để biến 8 ô thành mảnh ảnh, hoặc chơi ngay bằng số thường.",
        "image_board_mode": "Chế độ board",
        "image_number_mode_hint": "Chưa có ảnh: board số vẫn chơi được ngay.",
        "image_play_steps_title": "Cách chơi",
        "image_play_step_upload": "Tải ảnh nếu muốn chơi bằng ảnh; không bắt buộc.",
        "image_play_step_click": "Bấm ô nằm cạnh ô trống để di chuyển.",
        "image_play_step_start": "Bấm Dùng làm trạng thái bắt đầu nếu muốn đưa ván này sang solver.",
        "shuffle_game": "Trộn ván",
        "game_shuffled": "Đã trộn ván chơi {moves} bước; Start solver chưa đổi.",
        "game_start_synced": "Đã dùng ván hiện tại làm Start cho solver.",
        "algorithm_demo_gif": "GIF chạy thật",
        "algorithm_demo_caption": "{algorithm} chạy từ core thật với cấu hình demo cố định.",
        "algorithm_demo_missing": "Chưa có GIF cho thuật toán này. Hãy chạy script tạo tài sản demo.",
    ...
    "en": {
        ...
        "seconds_per_step": "{seconds}s / step",
        ...
        "image_setup_title": "Game setup",
        "image_upload_hint": "Upload an image to turn the 8 tiles into picture pieces, or play immediately with number tiles.",
        "image_board_mode": "Board mode",
        "image_number_mode_hint": "No image yet: the number board is ready to play.",
        "image_play_steps_title": "How to play",
        "image_play_step_upload": "Upload an image if you want picture tiles; this is optional.",
        "image_play_step_click": "Click a tile next to the blank to move it.",
        "image_play_step_start": "Click Use as start state to send this board to the solver.",
        "shuffle_game": "Shuffle game",
        "game_shuffled": "Shuffled the game {moves} moves; solver Start is unchanged.",
        "game_start_synced": "Current game board is now the solver Start.",
        "algorithm_demo_gif": "Live-run GIF",
        "algorithm_demo_caption": "{algorithm} running through the real core with a fixed demo configuration.",
        "algorithm_demo_missing": "This algorithm GIF has not been generated yet. Run the demo asset script.",
