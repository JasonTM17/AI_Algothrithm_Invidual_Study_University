...
TEXT: Dict[str, Dict[str, str]] = {
    "vi": {
        ...
        "experiment_done": "Đã chạy {rows} dòng ({presets} preset × {algorithms} thuật toán)",
        "experiment_no_baseline": "không tìm được",
        # Report tab
        "report_title": "Báo cáo bài nộp",
        "report_idle": "Chưa có báo cáo — chạy Run trước, rồi nhấn Generate.",
    ...
    "en": {
        ...
        "report_no_run": "No run yet — press Run in the sidebar first.",
